...
const Users = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await fetch("http://localhost:5000/api/getAllAgent"); // Update this URL with your actual backend API endpoint
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-100">
      <h1 className="mb-2 text-4xl font-bold text-pink-600">Agent List</h1>
      <Link href="/company/dashboard" className="mx-10 ms-auto"><button className="mb-3 text-4xl font-bold text-black ">Back</button></Link>
